...
class RentItemCreateRequest implements \JsonSerializable
{
    /**
    * type: String
    */
    ...
    */
    ...
    public function getIsPrivateDomain() {
        return $this->isPrivateDomain;
    }

    public function setIsPrivateDomain($isPrivateDomain) {
        $this->isPrivateDomain = $isPrivateDomain;
    }
...
class RentItemCreateItem implements \JsonSerializable
{
    /**
    * type: String
    */
...
class RentItemCreateItem1 implements \JsonSerializable
{
    /**
    * type: String
    */
