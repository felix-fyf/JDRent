...
class RentSpUnifiedPayApplyRequest implements \JsonSerializable
{
    /**
    * type: String
    */
...
class RentSpUnifiedPayApplyFeeDetail implements \JsonSerializable
{
    /**
    * type: String
    */
...
class RentSpUnifiedPayApplyDivisionAccountDetail implements \JsonSerializable
{
    /**
    * type: String
    */
